...
public class AdRequestsExampleScenes : MonoBehaviour
{
    ...
    public void BannerDocs() { OpenDocs(""); }

    public void CheckRewardedAdAvailability()
    {
        StaticHelpersGarterSDK.SdkDebugger("Garter.I.RewardedAdAvailability()", "-", "-");
        bool state = Garter.I.RewardedAdAvailability();
        StaticHelpersGarterSDK.SdkDebugger("Garter.I.RewardedAdAvailability()", state.ToString(), "-");
    }
    ...
    {
        Application.OpenURL("https://www.gamearter.com/developers/unity");
    }
}
